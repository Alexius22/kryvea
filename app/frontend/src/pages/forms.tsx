    ...
    <>
      ...
      <SectionMain>
        <SectionTitleLineWithButton icon={mdiBallotOutline} title="Formik forms example" main>
          <Button icon={mdiGithub} label="Star on GitHub" color="contrast" roundedFull small />
        ...
        <CardBox>
          ...
          >
            <Form>
              ...
              <FormField label="With help line and labelFor" labelFor="phone" help="Help line comes here">
      ...
      <SectionMain>
        <CardBox>
          <Formik initialValues={{ checkboxes: ["lorem"], switches: ["lorem"], radio: "lorem" }} onSubmit={() => null}>
            <Form>
